...
class Rsm extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'view_url'=>'rsm',
						   	'status_value'=>'rsm',
						   	'multiple_delete'=>'admin_con/rsm/delete_all',
						   	'pagination_url'=>'admin_con/rsm/listing',
						   	'controller_name'=>'rsm',
						   	'page_name'=>'rsm.php',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(19,2);
	...
	function listing()
	{
		check_controller_inner_access(19,1);	
		$search = $this->input->post("search");

		$this->load->library("pagination");			
		$config = array();  
    $config["base_url"] = base_url($this->arr_values['redirect_path'].'listing');
    $config["total_rows"]  = $totalrow = count($this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('role'=>2)));
	...
	public function delete($id)
	  ...
	  function delete_all()
		{
			check_controller_inner_access(19,4);	
	...
	function edit()
	{
		check_controller_inner_access(19,3);		 
		$args=func_get_args();
	...
	function view()
	{
		 check_controller_inner_access(19,5);
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
