...
class add_distributer extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'load_path'=>'admin/add_distributer/',
						   	'redirect_path'=>'admin_con/add_distributer/',
						   	'back_url'=>'add_distributer',
						   	'add_url'=>'add_distributer',
						   	'edit_url'=>'add_distributer',
						   	'delete_url'=>'add_distributer',
						   	'view_url'=>'add_distributer',
						   	'status_value'=>'add_distributer',
						   	'multiple_delete'=>'admin_con/add_distributer/delete_all',
						   	'pagination_url'=>'admin_con/add_distributer/listing',
						   	'controller_name'=>'add_distributer',
						   	'page_name'=>'add_distributer.php',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(22,2);
		if(isset($_POST['submit']))
		{
			...
			$data['sales_office_id'] = $this->input->post('sales_office_id');			
	...
	function listing()
	{
		check_controller_inner_access(22,1);	
		$search = $this->input->post("search");

		$this->load->library("pagination");			
		$config = array();  
    $config["base_url"] = base_url($this->arr_values['redirect_path'].'listing');
    $config["total_rows"]  = $totalrow = count($this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('role'=>5)));
    ...
    if(!empty($search))
    {
    	$this->db->where(" concat(name,firm_name,mobile,address) like '%$search%' ");
	...
	public function delete($id)
	  ...
	  function delete_all()
		{
			check_controller_inner_access(22,4);	
	...
	function edit()
	{
		check_controller_inner_access(22,3);		 
		$args=func_get_args();
	...
	function view()
	{
		 check_controller_inner_access(22,5);
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
