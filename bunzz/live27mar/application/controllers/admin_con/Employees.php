...
class Employees extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/employees/',
						   	'load_path'=>'admin/employees/',
						   	'redirect_path'=>'admin_con/employees/',
						   	'back_url'=>'employees',
						   	'add_url'=>'employees',
						   	'edit_url'=>'employees',
						   	...
						   	'multiple_delete'=>'admin_con/employees/delete_all',
						   	'pagination_url'=>'admin_con/employees/listing',
   ...
   //--check user login or not
    ...
    if(!empty($search))
    {
    	$this->db->where(" concat(name,email,mobile) like '%$search%' ");
