...
class Tbl_admin extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'pagination_url'=>'admin_con/tbl_admin/listing',
   ...
   //--check user login or not
    ...
    $config["total_rows"]  = $totalrow = count($this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('type'=>2)));
