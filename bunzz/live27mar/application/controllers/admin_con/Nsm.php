...
class Nsm extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'view_url'=>'nsm',
						   	'status_value'=>'nsm',
						   	'multiple_delete'=>'admin_con/nsm/delete_all',
						   	'pagination_url'=>'admin_con/nsm/listing',
						   	'controller_name'=>'nsm',
						   	'page_name'=>'nsm.php',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		check_controller_inner_access(18,2);
	...
	function listing()
	{
		check_controller_inner_access(18,1);	
	...
	public function delete($id)
	  ...
	  function delete_all()
		{
			check_controller_inner_access(18,4);	
	...
	function edit()
	{
		check_controller_inner_access(18,3);		 
		$args=func_get_args();
	...
	function view()
	{
		 check_controller_inner_access(18,5);
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
