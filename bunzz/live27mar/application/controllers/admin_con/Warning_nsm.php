...
class Warning_nsm extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Notices',
						   	'table_name'=>'warning_nsm',
						   	'upload_path'=>'media/uploads/warning_nsm/',
						   	'load_path'=>'admin/warning_nsm/',
						   	'redirect_path'=>'admin_con/warning_nsm/',
						   	'back_url'=>'warning_nsm',
						   	'add_url'=>'warning_nsm',
						   	'edit_url'=>'warning_nsm',
						   	'delete_url'=>'warning_nsm',
						   	'view_url'=>'warning_nsm',
						   	'status_value'=>'warning_nsm',
						   	'multiple_delete'=>'admin_con/warning_nsm/delete_all',
						   	'pagination_url'=>'admin_con/warning_nsm/listing',
						   	'controller_name'=>'warning_nsm',
						   	'page_name'=>'',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		 check_controller_inner_access(24,2);
	...
	function listing()
	{
		check_controller_inner_access(24,1);
    ...
    if(!empty($search))
    {
    	$this->db->where(" concat(nsm_id,message) like '%$search%' ");
	...
	public function delete($id)
	  {
	  	check_controller_inner_access(24,4);
	...
	function edit()
	{
		check_controller_inner_access(24,3);
		$args=func_get_args();
	...
	function view()
	{
		check_controller_inner_access(24,5);
		$args=func_get_args();
		$data['page_title'] = $this->arr_values['page_title'];
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['back_url'] = base_url('admin_con/'.$this->arr_values['back_url'].'/listing');
