        ...
        if(!empty($user))
        {
            ...
            if($user['status']==1)
            {
                if($user['password']==$password)
                {
                    ...
                    if($user['role']==5)
                    {                           
                        $url = base_url('app/distributor/home?device_id='.$device_id.'&firebase_token='.$firebase_token);
                    }
                    else if($user['role']==2)
                    {
                        $url = base_url('app/rsm/home?device_id='.$device_id.'&firebase_token='.$firebase_token);
                    }  
