    ...
    function add_employe()
    {
        if(isset($_POST['submit']))
        {
            ...
            if($_FILES['image']['name']!='')
            {
                ...
                $path = "media/uploads/employees/".$bimage;
            ...
            $data['image'] = $bimage;
            $data['add_by'] = $this->session->userdata("user")['id'];  
            ...
            $url = base_url('app/hr/home.php?device_id='.$device_id.'&firebase_token='.$firebase_token);
            redirect($url); 
        }
    ...
    function update_employe()
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($_FILES['image']['name']!='')
            {
                ...
                $path = "media/uploads/employees/".$image;
                move_uploaded_file($_FILES['image']['tmp_name'],$path);
            }
            else
            {
            ...
            $this->crud->update('employees',$get_id,$data);
            $url = base_url('app/hr/home.php?device_id='.$device_id.'&firebase_token='.$firebase_token);
            redirect($url);
        }
    }
