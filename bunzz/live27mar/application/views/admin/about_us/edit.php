                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="mission"rows="6"><?php echo $EDITDATA[0]->mission; ?></textarea>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="vision" rows="6"><?php echo $EDITDATA[0]->vision; ?></textarea>
                                 </div>
                              </div>
