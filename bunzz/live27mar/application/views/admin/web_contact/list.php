                        ...
                        <table id="headerTable" class="table table-striped table-bordered align-middle">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">Query Type</th>
                                 <th class="text-nowrap">Currently Performing Distribution In</th>
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td class=""><?php echo $data->state; ?></td>
                                 <td class=""><?php echo $data->query_type; ?></td>
                                 <td class=""><?php echo $data->curent_disr; ?></td>
                                 <td class=""><?php echo date('Y/m/d',strtotime($data->addeddate)); ?></td>
                                 <td>
                                    <a href="<?php echo $view_url.$data->id; ?>" class="btn btn-primary btn-sm">View</a>
                                    <?php
                                    if(check_controller_inner_access(2,4)==false)
                                       {
                                          $display = "none";
                                       }
                                       else
                                    ...
                                    <a href="<?php echo $delete_url.$data->id; ?>" class="btn btn-danger btn-sm delete" style="display: <?=$display ?>;">Delete</a>
                                 </td>
                              </tr>
                           <?php } ?>
