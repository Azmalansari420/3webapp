                        ...
                        <table class="table table-striped table-bordered align-middle" id="headerTable">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">MRP Price</th>
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td class=""><?php echo categoryname($data->cat_id); ?></td>
                                 <td class=""><?php echo subcategoryname($data->cat_id); ?></td>
                                 <td >
                                    <img src="<?php echo base_url($upload_path); ?><?php echo $data->thumb_img; ?>" class="rounded h-60px my-n1 mx-n1" width="75"/>
                                 </td>
                                 <td class=""><?php echo $data->name; ?></td>
                                 <td class=""><?php echo $data->mrp_price; ?></td>
                                 <td class=""><?php echo $data->sale_price; ?></td>
                                 <td class=""><?php echo $data->stock; ?></td>
                                 <td class=""><?php echo $data->sku_code; ?></td>
