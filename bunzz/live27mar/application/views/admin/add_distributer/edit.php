                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <select class="form-select sales-officer-list" name="sales_office_id" required>
                                       <?php
                                       $rsm = $this->crud->selectDataByMultipleWhere('users',array('role'=>4,'status'=>1,));
                                       foreach($rsm as $data)
                                          { ?>
                                       <option <?php if($EDITDATA[0]->sales_office_id==$data->id) echo 'selected'; ?> value="<?=$data->id ?>" ><?=$data->name ?></option>
                                    <?php } ?>
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Distrubutor Name</label>
                                    <input type="text" class="form-control" name="name" required value="<?=$EDITDATA[0]->name ?>">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Distrubutor Firm Name</label>
                                    <input type="text" class="form-control" name="firm_name" required value="<?=$EDITDATA[0]->firm_name ?>">
                                 </div>
                              </div>

                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Distributor Contact Person</label>
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="gst_no" value="<?=$EDITDATA[0]->gst_no ?>">
                                 </div>
                              </div>
                           ...
                           <div class="row">
                             ...
                             <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?=$EDITDATA[0]->email ?>">
                                 </div>
                              </div>
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
