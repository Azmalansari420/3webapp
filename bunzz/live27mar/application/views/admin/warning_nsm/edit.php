                           ...
                           <div class="row">
                              <div class="col-lg-12 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <select class="form-select" name="nsm_id" required>
                                       <option value="" selected>Select NSM</option>
                                          <?php
                                          $rsm = $this->crud->selectDataByMultipleWhere('users',array('status'=>1,'role'=>1,));
                                          foreach($rsm as $data)
                                              { ?>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="message" value="<?php echo $EDITDATA[0]->message; ?>">
                                 </div>
                              </div>
