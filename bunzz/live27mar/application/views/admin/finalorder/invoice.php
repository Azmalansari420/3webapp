            ...
            <div class="invoice" id="section-to-print">
               ...
               <div class="invoice-header">
                  ...
                  <div class="invoice-to">
                     <small>to</small>
                     <address class="mt-5px mb-5px">
                        <strong class="text-dark"><?php echo $EDITDATA[0]->name; ?> <?php ?> </strong><br />
                        Phone: <?php echo $EDITDATA[0]->mobile; ?><br />
                        Email: <?php echo $EDITDATA[0]->email; ?><br>
                        <?php echo $EDITDATA[0]->address; ?> <br />
                       <?=statename($EDITDATA[0]->state) ?><br>
                        <?=cityname($EDITDATA[0]->city) ?><br> <br/>
                     ...
                     <table class="table table-invoice">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td><?php echo $i; ?></td>
                              <td >
                                 <img class="avatar is-squared" style="height: 75px;" alt="user-icon" src="<?php echo base_url(); ?>media/uploads/product/<?php echo $order->image; ?>">
                              </td>
                              <td>
                                 <strong>Name:- </strong> <?php echo $order->name; ?><br>
                              </td>
                              <td><?php echo number_format($order->sale_price,2); ?></td>
                              <td><?php echo $order->quantity; ?></td>
                              <td>₹ <?php echo number_format($order->quantity*$order->sale_price,2); ?></td>
                           </tr>
