    ...
    <div class="mt-5" style="padding-bottom: 70px;">
        <div class="tf-container">
            ...
            <form class="tf-form mt-5" action="" id="form-data">
               ...
               <input type="hidden" class="so_id" value="<?=$full_detail->id ?>">

               <input type="hidden" class="asm_id" value="<?=$full_detail->asm_id ?>">
               <input type="hidden" class="distributer_id" value="<?php if(!empty($target)) echo $target->distributer_id ?>">
                ...
                <div class="group-input">
                    <label>Reply To <?=userdetails($target->distributer_id) ?></label>
            ...
            <?php } ?>
                ...
                if(!empty($target))
                    { ?>
                    <button type="button" class="tf-btn accent large esclate-submit-btn">Escalate to ASM  </button>
                <?php } ?>
                </div>
            </form>
        </div>
...
const get_id = '<?=$id ?>';
    ...
    function add_target()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/sales_officer/add_upadate_raise",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
    ...
    function esclatethis()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/sales_officer/esclatethis",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
