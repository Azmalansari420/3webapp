    ...
    <div class="header is-fixed">
        <div class="tf-container">
            <div class="tf-statusbar d-flex justify-content-center align-items-center">
                <a href="javascript:void(0);" id="btn-popup-left" class="back-btn2"> <i class="icon-more"></i> </a>
                <h3>Assign Target List</h3>
                <a href="assign-target.php" class="action-right"><i class="icon-plus"></i></a>
            </div>
        </div>
    </div>
                        ...
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                                ...
                                $users = $this->crud->selectDataByMultipleWhere('target_rsm_to_asm', array('rsm_id' => $full_detail->id,));
                                ...
                                ?>
                                    <li class="list-card-invoice">
                                        ...
                                        <div class="content-right">
                                            <h4>
                                                <?php
                                                if (($currentTimestamp - $addedTimestamp) <= (48 * 60 * 60)) {
                                                    ?>
                                                <a href="<?= ('rsm/assign-target-edit.php?id=' . $data->id) ?>">
                                                <?php } else{ ?>
                                                    <a href="javascript:;">
                                                <?php } ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <?php
                                                            if (($currentTimestamp - $addedTimestamp) >= (48 * 60 * 60)) {
                                                                ?>
                                                            <i data-id="<?=$data->id ?>" class="delete-btn icon-clear"></i>
                                                        <?php } else{?>
...
<script>
    ...
    function delete_target()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/rsm/delete_target",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
