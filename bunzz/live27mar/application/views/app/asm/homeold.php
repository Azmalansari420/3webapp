          ...
          <div class="tf-tab box-components mt-0 tf-container" style="paddi1ng1: 10px 0;">
            ...
            <table class="table"> 
                ...
                <tbody >
                  ...
                  $i=0;
                  $this->db->select('user_id,asm_id,city,state, SUM(after_discount_final_price) as total_spent');
                  ...
                  foreach($userorder as $data)
                    { 
                      $i++; 
                      // $name = distributerfirm($data->user_id); // Get the user name
                ...
                <div class="wallet-footer">
                    <ul class="d-flex justify-content-between align-items-center">
                        <li class="wallet-card-item">
                            <a href="approved-distributor-list.php" class="fw_6 text-center" id="btn-popup-down">
                        ...
                        <li class="wallet-card-item"><a class="fw_6" href="pending-distributor-list.php">
                                <ul class="icon icon-face-ID">
                                    <li class="path1"></li>
                                    <li class="path2"></li>
                                    <li class="path3"></li>
                                    <li class="path4"></li>
                        ...
                        <li class="wallet-card-item"><a class="fw_6 btn-card-popup" href="active-sales-officer.php">
                  ...
                  <li class="nav-item col-6" >
                      ...
                      <select class="form-select distributer-list" name="distributer_id" >
                        <option selected value="">Select Distributer</option>
                         <?php
                         $rsm = $this->crud->selectDataByMultipleWhere('users',array('role'=>5,'status'=>1,'asm_id'=>$full_detail->id));
                         foreach($rsm as $data)
                            { ?>
                         <option value="<?=$data->id ?>" ><?=$data->name ?></option>
                      <?php } ?>
...
<script>
 ...
 google.charts.load("current", {packages:["corechart"]});
  ...
  function drawChart() {
      ...
      var options = {
          title: 'Total Spent By Sales Officer',
          is3D: true,
      };
...
function getdata() {
    ...
    var settings = {
        "url": "<?=base_url() ?>api/asm/leadgerdata",
        "method": "POST",
        "dataType": "json",
        "timeout": 0,
        "processData": false,
