      ...
      <div class="card-secton" style="margin-top: 0;">
            ...
            <div class="tf-balance-box">
                <div class="wallet-footer">
                    <ul class="d-flex justify-content-between align-items-center">
                        ...
                        <li class="wallet-card-item"><a class="fw_6" href="distributer-list.php">
                        ...
                        <li class="wallet-card-item"><a class="fw_6 btn-card-popup" href="javascript:void(0);">
                        ...
                        <li class="wallet-card-item"><a class="fw_6" href="javascript:void(0);">
                                <ul class="icon icon-info">
                                    <li class="path1"></li>
                                    <li class="path2"></li>
                                    <li class="path3"></li>
                                    <li class="path4"></li>
        ...
        <!-- <div class="bill-content">
          <div class="container">
              ...
              <h3 class="fw_6 d-flex justify-content-between mt-3"> Verification Request <a href="distributer-list.php">View All</a></h3>
              <ul class="mt-3 mb-5">
                <?php
                ...
                foreach($users as $data)
                  ...
                  <li class="list-card-invoice">
                      <div class="logo">
                          <img src="<?=base_url() ?>media/uploads/distributor/<?=$data->self_image ?>">
                      </div>
            ...
            <h3 class="fw_6 d-flex justify-content-between mb-3"> Filter </h3>
              ...
              <form  method="get" class="nav nav-tabs lined row" role="tablist" style="justify-content: space-1around!important;">
                  ...
                  <li class="nav-item col-6" >
                      ...
                      <select class="form-select sales-officer-list" name="sales_office_id" ></select>
                  </li>

                 <!--  <li class="nav-item col-6" >
                      <label>Select Distributer</label>
                      <select class="form-select distributer-list" name="distributer_id" ></select>
                  </li> -->
...
//         // Collect the form data and make the AJAX request
...
//                 // Populate dataPoints array from the response
