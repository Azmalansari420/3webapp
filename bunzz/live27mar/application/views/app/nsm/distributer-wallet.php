      ...
      <div class="card-secton" style="margin-top: 0;">
        ...
        <div class="mt-5 tf-tab">
          <div class="tf-tab box-components mt-0 tf-container" style="paddi1ng1: 10px 0;">
              ...
              $asm_users = $this->db->get_where('users',array('nsm_id'=>$full_detail->id,'role'=>3))->result_object();
              ...
              <table class="table"> 
                ...
                <tbody >
                  <?php
                    ...
                    // Fetch ASM users
                    $asm_users2 = $this->db->get_where('users', array('nsm_id' => $full_detail->id, 'role' => 3))->result_object();
