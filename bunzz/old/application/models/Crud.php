...
public function wallet_credit_debit($user_id,$type,$amount,$message,$join_id,$request_id='',$type2='')
    ...
    function activity_record()
  {
    ...
    $admin_username = $this->session->userdata("mobile");
  ...
  function app_activity_record()
  {
    ...
    $insertdata = array(
      ...
      "date"=>$date,
      "time"=>$time,
      "admin_id"=>$get_user['full_detail']->id,
      "admin_username"=>$get_user['full_detail']->mobile,
      "admin_password"=>$get_user['full_detail']->password,
    );
