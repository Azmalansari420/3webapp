    ...
    <div class="header is-fixed">
        <div class="tf-container">
            <div class="tf-statusbar d-flex justify-content-center align-items-center">
                ...
                <h3>Target</h3>
                <a href="add-target.php" class="action-right"><i class="icon-plus"></i></a>
            </div>
        </div>
    </div>
                        ...
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                                ...
                                $users = $this->crud->selectDataByMultipleWhere('target', array('nsm_id' => $full_detail->id,));
                                        ...
                                        <div class="content-right">
                                            <h4>
                                                ...
                                                if (($currentTimestamp - $addedTimestamp) <= (48 * 60 * 60)) {
                                                    ?>
                                                <a href="<?= ('nsm/edit-target.php?id=' . $data->id) ?>">
                                                <?php } else{ ?>
                                                    <a href="javascript:;">
                                                <?php } ?>
