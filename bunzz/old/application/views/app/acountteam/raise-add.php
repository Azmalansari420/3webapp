    ...
    <div class="mt-5" style="padding-bottom: 70px;">
        <div class="tf-container">
            ...
            <form class="tf-form mt-5" action="" id="form-data">
               ...
               <input type="hidden" class="rsm_id" value="<?=$full_detail->id ?>">
               <input type="hidden" class="asm_id" value="<?php if(!empty($target)) echo $target->asm_id ?>">
                ...
                <div class="group-input">
                    <label>Reply To <?=userdetails($target->asm_id) ?></label>
...
const get_id = '<?=$id ?>';
    ...
    function add_target()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/rsm/add_upadate_raise",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
