...
<style>
    ...
    <div class="wrap-success">
            ...
            <div class="success_box">
                ...
                <!-- <div class="content">
                    <div class="top">
                        <h2 style="    font-size: 55px;">Not Found!</h2>
                    </div>
                    <div class="tf-spacing-16"></div>                        
                </div> -->
                <a href="#!" class="tf-btn accent large back-btn">Go to Back</a>
                <a href="<?=base_url('api/auth/logout') ?>" class="mt-2 tf-btn btn-primary large">Go to Login</a>
