                ...
                <h3 class="fw_6 d-flex justify-content-between mb-3"> Download Report </h3>
                  ...
                  <form  method="get" class="nav nav-tabs lined row" role="tablist" style="justify-content: space-1around!important;">
                      ...
                      <li class="nav-item col-6" >
                          ...
                          <select class="form-select category" name="name" >
                             <option selected value="">Select Category</option>
                             <?php
                             $this->db->group_by('name');
                             $rsm = $this->crud->selectDataByMultipleWhere('orders',array('rsm_id'=>$full_detail->id));
                             foreach($rsm as $data)
                                { ?>
                      ...
                      <li class="nav-item col-6" >
                          ...
                          <select class="form-select sku_code" name="sku_code" >
                             ...
                             foreach($rsm as $data)
                                { ?>
                             <option value="<?=$data->sku_code ?>" ><?=$data->sku_code ?></option>
                          <?php } ?>
                          </select>
                      </li>
