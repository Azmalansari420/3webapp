                    ...
                    <div class="tab-content mt-4">
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              ...
                              $users = $this->crud->get_data('employees');
                              ...
                              foreach($users as $data)
                                ...
                                <li class="list-card-invoice">
                                    <div class="logo">
                                        <img src="<?=base_url() ?>media/uploads/employees/<?=$data->image ?>" onerror="this.src='<?=base_url() ?>media/uploads/1725100321.jpg'">
                                    </div>
                                    <div class="content-right">
                                        <h4>
                                          <a href="<?=('hr/employees-update.php?id='.$data->id) ?>"><?=$data->name ?> 
                                            <?=status($data->status) ?>
                                          </a>
                                        </h4>
                                        <span style="font-weight: 700;color: green;"><?=($data->employee_code) ?></span>
                                        <p><?=$data->mobile ?> <br> <?=$data->address ?></p>
                                    </div>
                                </li>
                                <?php }  ?>
                            </ul>
