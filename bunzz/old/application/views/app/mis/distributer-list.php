                    ...
                    <div class="tab-content mt-4">
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              ...
                              $users = $this->crud->selectDataByMultipleWhere('kyc_records',array());
                              ...
                              foreach($users as $data)
                                ...
                                <li class="list-card-invoice">
                                    ...
                                    <div class="content-right">
                                        <h4>
                                          <a href="<?=('mis/distributor-kyc-details.php?id='.$data->id) ?>"><?=$data->firm_name ?> 
                        ...
                        <div class="tab-pane fade" id="tabIcon2" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                              $this->db->order_by('id desc');
                              $users = $this->crud->selectDataByMultipleWhere('kyc_records',array('status'=>1));
                              foreach($users as $data)
                                {
                        ...
                        <div class="tab-pane fade" id="tabIcon3" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                              $this->db->order_by('id desc');
                              $users = $this->crud->selectDataByMultipleWhere('kyc_records',array('status'=>2));
                              foreach($users as $data)
                                {
                        ...
                        <div class="tab-pane fade" id="tabIcon4" role="tabpanel">
                          <?php
                              $this->db->order_by('id desc');
                              $users = $this->crud->selectDataByMultipleWhere('kyc_records',array('status'=>3));
                              foreach($users as $data)
                                {
