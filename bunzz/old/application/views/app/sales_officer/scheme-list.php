                    ...
                    <div class="tab-content mt-4">
                        ...
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              ...
                              $users = $this->crud->selectDataByMultipleWhere('scheme',array('status'=>1,));
                              ...
                              foreach($users as $key =>  $data)
                                ...
                                <li class="list-card-invoice">
                                    <div class="content-right">
                                        <h4> <a style="font-size: 17px;" ><?=$key + 1 ?>. <?=$data->name ?></a></h4>
                                        <?php
                                        if(!empty($data->pdf))
                                            { ?>
                                        <a download class="download-btn" href="<?=base_url('media/uploads/schema/'.$data->pdf) ?>" >Download PDF</a>
                                    <?php } ?>
                                    </div>
                                </li>
                                <?php } } ?>
