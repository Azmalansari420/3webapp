                        ...
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                                ...
                                $users = $this->crud->selectDataByMultipleWhere('raise_distributer_to_so', array('so_id' => $full_detail->id,));
                                    ...
                                    <li class="list-card-invoice">
                                        ...
                                        <div class="content-right">
                                            <h4>
                                                ...
                                                <a href="<?= ('sales_officer/raise-add.php?id=' . $data->id) ?>">
                                                
                                                    <?=raiseissue($data->issue_type) ?><br> [from <?=userdetails($data->distributer_id) ?>]
