    ...
    <div class="header is-fixed">
        <div class="tf-container">
            <div class="tf-statusbar d-flex justify-content-center align-items-center">
                ...
                <a href="notice-add.php" class="action-right"><i class="icon-plus"></i></a>
            </div>
        </div>
    </div>
                        ...
                        <div class="tab-pane fade show active" id="tabIcon1" role="tabpanel">
                            <ul class="mt-3 mb-5">
                              <?php
                                ...
                                $users = $this->crud->selectDataByMultipleWhere('warning_so', array('asm_id' => $full_detail->id,));
                                        ...
                                        <div class="content-right">
                                            <h4>
                                                ...
                                                if (($currentTimestamp - $addedTimestamp) <= (48 * 60 * 60)) {
                                                    ?>
                                                <a href="<?= ('asm/notice-add.php?id=' . $data->id) ?>">
                                                <?php } else{ ?>
                                                    <a href="javascript:;">
                                                <?php } ?>
...
<script>
    ...
    function delete_target()
    {
        ...
        var settings = {
          "url": "<?=base_url() ?>api/asm/delete_target",
          "method": "POST",
          "dataType": "json",
          "timeout": 0,
          "processData": false,
