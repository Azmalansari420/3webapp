        ...
        <div class="detail-img">
          <div class="gallery">
            ...
            <div class="main-image">
              <?php
              $allimage = json_decode($product->image);
              if(!empty($allimage))
              {
                foreach($allimage as $key => $value)
                {
              ?>
              <img src="<?=base_url() ?>media/uploads/product/<?=$value ?>" alt="Image 1" class="<?php if($key==0) echo 'active'; ?>">
             <?php }  }?>
            ...
            <div class="thumbnails">
              ...
              if(!empty($allimage))
              {
                ...
                {
              ?>
              <img src="<?=base_url() ?>media/uploads/product/<?=$value ?>" alt="Thumbnail 1" class="<?php if($key==0) echo 'active'; ?>" data-index="<?=$key ?>">
             <?php  } } ?>
    ...
    <div class="container swiper">
      ...
      <div class="row pro-slider">
        <div class="swiper-wrapper">
          ...
          $product = $this->crud->selectDataByMultipleWhere('product',array('status'=>1,'cat_id'=>$catid));
          ...
          <a href="<?=base_url() ?>product-detaile?id=<?=$data->id ?>" class="product-card swiper-slide" data-aos="fade-up" data-aos-delay="100">
