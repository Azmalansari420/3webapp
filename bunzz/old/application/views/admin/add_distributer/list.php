                        ...
                        <table class="table table-striped table-bordered align-middle" id="headerTable">
                           <thead>
                              <tr>
                                 ...
                                 <th class="text-nowrap">Distrubutor Name</th>
                                 <th class="text-nowrap">Firm Name</th>
                                 <th class="text-nowrap">Contact Person</th>
                                 <th class="text-nowrap">GSTIN Number</th>
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <img src="<?=base_url($upload_path) ?><?=$data->profile_image ?>" alt="image" onerror="this.src='<?=base_url() ?>media/uploads/1725100321.jpg'" width="100">
                                 </td>
                                 ...
                                 <td class=""><?php echo $data->gst_no; ?></td>
                                 <td class=""><?php echo $data->email; ?></td>
                                 <td class=""><?php echo $data->password; ?></td>
                                 <td class=""><?php echo distributer_status($data->kyc_status); ?></td>
