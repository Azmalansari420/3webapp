...
class Youtube extends CI_Controller
{
	...
	protected $arr_values = array(
						   	'page_title'=>'Youtube',
						   	'table_name'=>'youtube',
						   	'upload_path'=>'media/uploads/youtube/',
						   	'load_path'=>'admin/youtube/',
						   	'redirect_path'=>'admin_con/youtube/',
						   	'back_url'=>'youtube',
						   	'add_url'=>'youtube',
						   	'edit_url'=>'youtube',
						   	'delete_url'=>'youtube',
						   	...
						   	'multiple_delete'=>'admin_con/youtube/delete_all',
						   	'pagination_url'=>'admin_con/youtube/listing',
						   	'controller_name'=>'youtube',
						   	'page_name'=>'youtube.php',
						   ); 
   ...
   //--check user login or not
    ...
    if(!empty($search))
    {
    	$this->db->where(" concat(name,position) like '%$search%' ");
