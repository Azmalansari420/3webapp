...
class Role extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'pagination_url'=>'admin_con/role/listing',
   ...
   //--check user login or not
	...
	function listing()
	{
		...
		// role_access(2,$this->arr_values['controller_name']);
	...
	function edit()
	{
	    ...
	    $main_access = $this->input->post('main_access');
     	...
     	$all_access = array("main_access"=>$main_access,"inner_access"=>$inner_access,);
			...
			$this->db->update('tbl_admin',array('access'=>$role_access),array('role'=>$insert_id));
