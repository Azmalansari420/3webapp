...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/recharge_request/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/recharge_request/listing');?>">
               <span class="nav-icon"><i class="fa fa-bell bg-black text-white"></i></span>
               <span class="nav-text">Recharge Request</span>
            </a>
         </li>
