...
class Site_setting extends CI_Controller
{
	...
	function edit()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['buttons'] = $this->input->post('buttons');
			$data['withdraw'] = $this->input->post('withdraw');
			$data['help_url'] = $this->input->post('help_url');
	...
	function upi()
	{
		...
		if(isset($_POST['submit']))
		{
			$data['upi'] = $this->input->post('upi');
			$data['upi_2'] = $this->input->post('upi_2');
			$data['upi_3'] = $this->input->post('upi_3');
		...
		$data['upload_path'] = $this->arr_values['upload_path'];
		$data['EDITDATA'] = $this->crud->fetchdatabyid($args[0],$this->arr_values['table_name']);
		$this->load->view($this->arr_values['load_path'].'upi',$data);
	}
