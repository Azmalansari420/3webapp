...
class Sub_admin extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/sub_admin/',
						   	'load_path'=>'admin/sub_admin/',
						   	'redirect_path'=>'admin_con/sub_admin/',
						   	'back_url'=>'sub_admin',
						   	'add_url'=>'sub_admin',
						   	'edit_url'=>'sub_admin',
						   	'delete_url'=>'sub_admin',
						   	'view_url'=>'sub_admin',
						   	'status_value'=>'sub_admin',
						   	'multiple_delete'=>'admin_con/sub_admin/delete_all',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$username = $this->crud->selectDataByMultipleWhere('tbl_admin',array('username'=>$username));
			if(empty($username))
			{
	...
	function listing()
	{
		...
		$data['ALLDATA'] = $this->crud->selectDataByMultipleWhere($this->arr_values['table_name'],array('role'=>2,));
