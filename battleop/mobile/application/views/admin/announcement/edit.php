                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="messge" id="e1ditor"  placeholder="Enter text ..." rows="12"><?php echo $EDITDATA[0]->messge; ?></textarea>
                                 </div>
                              </div>
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">External Links</label>
                                    <input type="text" class="form-control" name="external_link"  value="<?php echo $EDITDATA[0]->external_link; ?>">
                                 </div>
                              </div>
