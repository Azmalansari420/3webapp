                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <form method="post" action="<?=base_url('admin_con/matches/status_change') ?>">
                                       ...
                                       <select class="form-select mb-1" <?php if(empty($data->room_id)) echo 'disabled' ?> name="status" <?php if($data->status==4) echo 'disabled'; ?>>
                                          ...
                                          <option value="3" <?php if($data->status=='3') echo 'selected'; ?>>Complete Match</option>
                                          <option value="4" <?php if($data->status=='4') echo 'selected'; ?>>Cancel Match</option>
                                       </select>
                                       <input type="submit" name="submit" <?php if(empty($data->room_id)) echo 'disabled' ?> <?php if($data->status==4) echo 'disabled'; ?>>
                                    </form>
                                 </td>
