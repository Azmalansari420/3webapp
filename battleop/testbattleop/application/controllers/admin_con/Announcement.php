...
class Announcement extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/announcement/',
						   	'load_path'=>'admin/announcement/',
						   	'redirect_path'=>'admin_con/announcement/',
						   	'back_url'=>'announcement',
						   	'add_url'=>'announcement',
						   	'edit_url'=>'announcement',
						   	'delete_url'=>'announcement',
						   	'view_url'=>'announcement',
						   	'status_value'=>'announcement',
						   	'multiple_delete'=>'admin_con/announcement/delete_all',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['messge'] = $messge = $this->input->post('messge');			
