                     ...
                     <div class="panel-body">
                        <table id="data-table-buttons" class="table table-striped table-bordered align-middle">
                           ...
                           <tbody>
                              <?php
                              $i=0;
                              $matches = $this->crud->selectDataByMultipleWhere('matches',array('game_id'=>$EDITDATA[0]->id,'status'=>3));
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <a href="<?=base_url('admin_con/matches/view/'.$data->id) ?>" class="btn btn-primary btn-sm">View</a>
