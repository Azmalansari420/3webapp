                        ...
                        <table id="headerTable" class="table table-striped table-bordered align-middle">
                           ...
                           <tbody>
                              ...
                              <tr class="odd gradeX">
                                 ...
                                 <td class=""><?php if(!empty($user)) echo $user[0]->fname; ?><br><?php if(!empty($user)) echo $user[0]->mobile; ?><br>
                                    <a href="<?php echo base_url('admin_con/users/edit/'.$user[0]->id) ?>">Update Wallet</a>
                                 </td>
                                 <td class=""><?php echo $data->amount; ?></td>
                                 <td class=""><?php echo $data->balance; ?></td>
