                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12 mb-4">
                               ...
                               <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="telegram" value="<?php echo $EDITDATA[0]->telegram; ?>">
                                 </div>
                              </div>
                               <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Money Buttons</label>
                                    <input type="text" class="form-control" name="buttons" value="<?php echo $EDITDATA[0]->buttons; ?>">
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <textarea class="form-control" name="help_url" rows="6"><?php echo $EDITDATA[0]->help_url; ?></textarea>
                                 </div>
                              </div>
