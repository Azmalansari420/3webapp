        ...
        <div class="container">
            <div class="invite-wrap">
                ...
                <div class="input-wrap">
                    <input type="text" class="form-control" readonly value="<?=$full_detail->user_id ?>">
                ...
                <!-- <div class="text-center">
                    ...
                    <ul class="social-area mt-4">
                        ...
                        <li><a href="https://www.google.com/"><img class="google" src="<?=base_url() ?>assets/img/icon/google.svg" alt="img"></a></li>
