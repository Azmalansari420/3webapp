        ...
        <div class="container">
            ...
            <div class="amount-wrap mt-5">
                ...
                <?php  
                    ...
                    <?php } ?>
            <br>
            <span class="showbox" style="display:none;margin-top: 8px;text-align: center;">Withdrawal Clear Within 1,2 Hour</span>
            </div>
            ...
            <div class="modal-content">
                <div class="container">
                    <div class="modal-card-wrap text-center">
                        <p class="title model-title withdraw_msg">You are Succesfully Join Match</p>
    ...
    function user_withdraw()
    {
        ...
        $.ajax(settings).done(function (response) {
          ...
          // }
            ...
            $('.withdraw_msg').html(response.message);
        });
    }
</script>
