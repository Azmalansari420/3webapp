...
class Instruments extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/instruments/',
						   	'load_path'=>'admin/instruments/',
						   	'redirect_path'=>'admin_con/instruments/',
						   	'back_url'=>'instruments',
						   	'add_url'=>'instruments',
						   	'edit_url'=>'instruments',
						   	'delete_url'=>'instruments',
						   	'view_url'=>'instruments',
						   	'table_url'=>'admin/instruments/table',
						   	'status_value'=>'instruments',
						   	'multiple_delete'=>'admin_con/instruments/delete_all',
						   	'pagination_url'=>'admin_con/instruments/get_table_data',
						   	'controller_name'=>'instruments',
						   	'page_name'=>'instruments.php',
						   	'pagination_limit'=>'10',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['instrument_key'] = $this->input->post('instrument_key');			
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->or_like('instrument_key', $search);
