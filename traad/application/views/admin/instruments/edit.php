                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="text" class="form-control" name="instrument_key" value="<?=$EDITDATA[0]->instrument_key ?>"/>
                        </div>

                        <div class="col-4 form-group">
                           <label>Quantity </label>
                           <input type="text" class="form-control" name="quantity" value="<?=$EDITDATA[0]->quantity ?>"/>
                        </div>

                        <div class="col-4 form-group">
                           <label>Expirey Date </label>
                           <input type="date" class="form-control" name="expiry_date" value="<?=$EDITDATA[0]->expiry_date ?>"/>
                        </div>
