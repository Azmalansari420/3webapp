                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="date" class="form-control" name="start_date" value="<?=$EDITDATA[0]->start_date ?>"/>
                        </div>
                        <div class="col-6 form-group">
                           <label>Expirey Date </label>
                           <input type="date" class="form-control" name="expire_date" value="<?=$EDITDATA[0]->expire_date ?>"/>
                        </div>
