   ...
   <section class="section-t-space section-lg-b-space">
    <div class="custom-container">
      ...
      <div class="row justify-content-center">
        <div class="col-12" style="justify-content: center;display: contents;">

          <div class="balance-card mt-5">
              <p class="balance-title">BALANCE</p>
              <h2 class="balance-amount"> <?=currency_simble($full_detail->wallet) ?> <i class="fas fa-wallet"></i></h2>
              <button class="top-up-btn">TOP UP</button>
          </div>

          <div class="option-chain-card mt-5">
              <h2 class="option-title">OPTION CHAIN</h2>
              <button class="option-btn">NIFTY 50</button>
              <button class="option-btn">BANKNIFTY</button>
              <button class="option-btn">MIDCPNIFTY</button>
              <button class="option-btn">FINNIFTY</button>
              <button class="option-btn">SENSEX</button>
          </div>
