...
<head>
    ...
    <!-- #keywords -->
    <meta name="keywords" content="TRAAD">
    <!-- #description -->
    <meta name="description" content="TRAAD">
    <!-- #title -->
    <title>TRAAD</title>
    <!-- #favicon -->
        ...
        <div class="container  d-center ">
           <nav class="navbar py-2 py-xl-4 rounded-3 navbar-expand-lg w-100 justify-content-between ">
                <div class="d-flex align-items-center py-3">
                    ...
                    <a href="index.html" class="navbar-brand m-0 p-0 d-flex align-items-center gap-5 gap-xl-5 me-2 justify-mobile">
                        <img src="assets/logo.png" class="logo small_logo d-sm-none" alt="logo">
                        <img src="assets/logo.png" class="logo d-none d-sm-flex desktop-logo" alt="logo" style="width: 18% !important">
                    </a>
                </div>
                <!-- <div class="nav_alt">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbar-content">
                    <ul class="navbar-nav gap-2 gap-lg-3 gap-xxl-8  align-self-center mx-auto mt-4 mt-lg-0">
                        ...
                        <li><a class="dropdown-item" href="#how-works">How it Works</a></li>
                        <li><a class="dropdown-item" href="#why-choose">Why Choose Us</a></li>
                        <li><a class="dropdown-item" href="#benifits">Benifits</a></li>
                        <li><a class="dropdown-item" href="#faq">FAQ's</a></li>
                        <li><a class="dropdown-item" href="sign-up.php">Register</a></li>
