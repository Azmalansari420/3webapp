...
class Clientregistration extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'upload_path'=>'media/uploads/clientregistration/',
						   	'load_path'=>'admin/clientregistration/',
						   	'redirect_path'=>'admin_con/clientregistration/',
						   	'back_url'=>'clientregistration',
						   	'add_url'=>'clientregistration',
						   	'edit_url'=>'clientregistration',
						   	'delete_url'=>'clientregistration',
						   	'view_url'=>'clientregistration',
						   	'status_value'=>'clientregistration',
						   	'multiple_delete'=>'admin_con/clientregistration/delete_all',
						   	'pagination_url'=>'admin_con/clientregistration/listing',
						   	'controller_name'=>'clientregistration',
						   	'page_name'=>'',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			// $data['plant_capacity'] = $this->input->post('plant_capacity');	
			// $data['opratername'] = $this->input->post('opratername');	
    ...
    if(!empty($search))
    {
    	$this->db->where(" concat(title,sub_title) like '%$search%' ");
