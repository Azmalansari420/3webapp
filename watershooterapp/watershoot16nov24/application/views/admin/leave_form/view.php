                           ...
                           <div class="row">
                              <div class="col-lg-4 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" value="<?php echo date('Y/m/d h:i A',strtotime($EDITDATA[0]->from_date)); ?>" disabled>
                                 </div>
                              </div>
                              <div class="col-lg-4 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">To Date</label>
                                    <input type="text" class="form-control" name="name" value="<?php echo date('Y/m/d h:i A',strtotime($EDITDATA[0]->to_date)); ?>" disabled>
                                 </div>
                              </div>
                              <div class="col-lg-4 mb-4">
                                 <div class="mb-lg-0 mb-3">
