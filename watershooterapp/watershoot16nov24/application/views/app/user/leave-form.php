...
<style>
	...
	<div class="page-content space-top">
		<div class="container">
			...
			<div class="mb-3">
				<label class="form-label" for="qualification">From </label>
				<input type="date" id="enquiry_from" class="form-control" required>
			</div>
			<div class="mb-3">
				<label class="form-label" for="qualification">To </label>
				<input type="date" id="enquiry_to" class="form-control" required>
			</div>
...
function enquiry_name()
{
  ...
  var from_date = $("#enquiry_from").val();
  var to_date = $("#enquiry_to").val();
  ...
  var settings = {
    "url": "<?=base_url() ?>api/user/leave_form",
    "method": "POST",
    "dataType": "json",
    "timeout": 0,
    "processData": false,
