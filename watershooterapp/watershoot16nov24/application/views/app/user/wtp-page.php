...
<div class="page-wrapper">
	...
	<input type="hidden" id="water_type" value="3">
	...
	<div class="page-content space-top p-b80">
		<div class="container">
			...
			<!-- <div class="mb-3">
				<label class="form-label" for="phone">UF Feed Pump.</label>
				<input type="text" id="water_intel_para_tds" class="form-control bg-gray" placeholder="TDS">
			</div> -->
			<div class="mt-3">
				<label class="form-label" for="phone">Dosing Pump.</label>
				<textarea placeholder="Dosing Pump" class="form-control bg-gray" id="dosing_pump" rows="5"></textarea>
			</div>
			...
			<div class="offcanvas-body dz-filter-canvas">
				...
				<div class="form-check">
					...
					<label id="water_equipment_hpn_working">
						<input class="form-check-input" type="radio"  id="water_equipment_hpn_working" name="water_equipment_hpn_working" value="1">&nbsp; Ok
					</label>
					<label id="water_equipment_hpn_working">
						<input class="form-check-input" type="radio"  id="water_equipment_hpn_working" name="water_equipment_hpn_working" value="2">&nbsp; Not Ok
					</label>
				</div>
				<div class="form-check">
					<label class="form-check-label" for="water_">
					...
					<label id="water_equipment_hpn_standby">
						<input class="form-check-input" type="radio"  id="water_equipment_hpn_standby" name="water_equipment_hpn_standby" value="1">&nbsp; Ok
					</label>
					<label id="water_equipment_hpn_standby">
						<input class="form-check-input" type="radio"  id="water_equipment_hpn_standby" name="water_equipment_hpn_standby" value="2">&nbsp; Not Ok
					</label>
				</div>
			...
			<div class="offcanvas-body dz-filter-canvas">
			  ...
			  <div class="form-check">
			    ...
			    <div class="radio-options">
			      <label>
			        <input class="form-check-input" type="radio" name="piping_agitator" value="1" id="other_agitator"> Ok
			      </label>
			      <label>
			        <input class="form-check-input" type="radio" name="piping_agitator" value="2" id="other_agitator"> Not Ok
			      </label>
			    </div>
			  </div>
			  ...
			  <div class="form-check">
			    ...
			    <div class="radio-options">
			      <label>
			        <input class="form-check-input" type="radio" name="piping_acf" value="1" id="other_acf"> Ok
			      </label>
			      <label>
			        <input class="form-check-input" type="radio" name="piping_acf" value="2" id="other_acf"> Not Ok
			      </label>
			    </div>
			  </div>
			   ...
			   <div class="form-check">
			    ...
			    <div class="radio-options">
			      <label>
			        <input class="form-check-input" type="radio" name="piping_acf" value="1" id="other_sofner"> Ok
			      </label>
			      <label>
			        <input class="form-check-input" type="radio" name="piping_acf" value="2" id="other_sofner"> Not Ok
			      </label>
			    </div>
			  </div>
			   <div class="form-check">
			    ...
			    <div class="radio-options">
			      <label>
			        <input class="form-check-input" type="radio" name="piping_uf" value="1" id="other_uf"> Ok
			      </label>
			      <label>
			        <input class="form-check-input" type="radio" name="piping_uf" value="2" id="other_uf"> Not Ok
			      </label>
			    </div>
			  </div>
			   <div class="form-check">
			    ...
			    <div class="radio-options">
			      <label>
			        <input class="form-check-input" type="radio" name="piping_uf" value="1" id="other_ro"> Ok
			      </label>
			      <label>
			        <input class="form-check-input" type="radio" name="piping_uf" value="2" id="other_ro"> Not Ok
			      </label>
			    </div>
			  </div>
			  ...
			  <div class="mb-3">
				...
				<input type="text" id="other_mgf" class="form-control bg-gray" placeholder="MGF">
			  </div>
...
function water_enquiry_form()
{
  ...
  var dosing_pump = $("#dosing_pump").val();
...
/*Equipment Conditions*/
  ...
  var water_equipment_hpn_working = $("#water_equipment_hpn_working:checked").val();
  var water_equipment_hpn_standby = $("#water_equipment_hpn_standby:checked").val();
...
/*other*/
  ...
  var other_agitator = $("#other_agitator").val();
  var other_acf = $("#other_acf").val();
  var other_sofner = $("#other_sofner").val();
  var other_uf = $("#other_uf").val();
  var other_ro = $("#other_ro").val();
  var other_mgf = $("#other_mgf").val();
  ...
  form.append("dosing_pump", dosing_pump);
  ...
  form.append("water_equipment_hpn_working", water_equipment_hpn_working);
  form.append("water_equipment_hpn_standby", water_equipment_hpn_standby);
  ...
  form.append("other_agitator", other_agitator);
  form.append("other_acf", other_acf);
  form.append("other_sofner", other_sofner);
  form.append("other_uf", other_uf);
  form.append("other_ro", other_ro);
  form.append("other_mgf", other_mgf);
  ...
  var settings = {
    "url": "<?=base_url() ?>api/user/wtp_form",
    "method": "POST",
    "dataType": "json",
    "timeout": 0,
    "processData": false,
