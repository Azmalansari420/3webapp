                        ...
                        <div class="col-4 form-group m-b-0">
                           ...
                           <select class=" form-control" required name="game_id">
                              ...
                              foreach($game as $data)
                                 { ?>
                              <option <?php if($EDITDATA[0]->game_id==$data->id) echo 'selected'; ?> value="<?=$data->id ?>"><?=$data->name ?></option>
                           <?php } ?>
                           </select>
                        </div>
                        <div class="col-4 form-group m-b-0">
                           ...
                           <select class=" form-control" required name="game_time_id">
                              ...
                              foreach($game as $data)
                                 { ?>
                              <option <?php if($EDITDATA[0]->game_time_id==$data->id) echo 'selected'; ?> value="<?=$data->id ?>"><?=date('h:i A',strtotime($data->time)) ?></option>
                           <?php } ?>
                           </select>
                        </div>
