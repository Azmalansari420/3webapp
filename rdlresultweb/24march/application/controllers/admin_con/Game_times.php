   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$data['game_time_id'] = $game_time_id = $this->input->post('game_time_id');

			$game_time = gametimein24hour($game_time_id);
			$data['declare_time'] = $game_time;
	...
	public function get_table_data() 
	{
	  ...
	  $this->db->like('game_time_id', $search);
